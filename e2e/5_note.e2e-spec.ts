// Below code is for existing TC about Note functionality with my new changes
...
describe('Note Functionality :', () => {
  ...
  it('Delete existing Notes', () => {
    page.getLastNote().element(by.css('button[type=notedeletebutton]')).click
  });
